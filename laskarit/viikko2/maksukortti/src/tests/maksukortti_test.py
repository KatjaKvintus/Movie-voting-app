...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_maukkaan_syominen_ei_vie_saldoa_negatiiviseksi(self):
        kortti = Maksukortti(200)
        kortti.syo_maukkaasti()
        self.assertEqual(str(kortti), "Kortilla on rahaa 2.00 euroa")
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_kun_kortilla_on_jaljella_vain_sen_arvon_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_kortilla_voi_ostaa_maukkaan_lounaan_kun_kortilla_on_jaljalla_vain_sen_arvon_verran(self):
